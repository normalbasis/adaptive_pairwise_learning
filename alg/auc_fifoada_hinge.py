...
def auc_fifoada_hinge(x_tr, y_tr, x_te, y_te, options):
    # get
    n_tr = options['n_tr']
    dim = options['dim']
    ...
    while t < n_iter:
        ...
        if y_t * y_t_1 < 0:
            ...
            # set initial lr
            # if i_res == 0 or aucs[i_res-1]<0.8:
            #     eta_t = eta_t/10
            ...
            if 1 - wyxx > 0.:
                ...
                gd = 0.
            # gradient step with momentum and adaptive step size
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        aucs, times = auc_fifoada_hinge(x_tr, y_tr, x_te, y_te, options)
        auc_sum[i] = aucs[-1]
        time_sum[i] = times[-1]
